...
mysql -u $myuser -p$mypassword wordpress < /$tmp/Originators.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/Aliases.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/ISC_Category.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/ISC_Moods.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/ISC_Topics.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/ISC_Genre.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/ISC_Domains.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/ISC_Subjects.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/ISC_Attributes.sql
mysql -u $myuser -p$mypassword wordpress < /$tmp/Article_Images.sql
