...
CREATE TABLE `Originators` (
  `originator_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `Originators_ibfk_3` FOREIGN KEY (`attribute_id`) REFERENCES `ISC_Attributes` (`attribute_id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `Originators_ibfk_4` FOREIGN KEY (`domain_id`) REFERENCES `ISC_Domains` (`domain_id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `Originators_ibfk_5` FOREIGN KEY (`user_id`) REFERENCES `wp_users` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
