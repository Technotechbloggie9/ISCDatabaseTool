...
CREATE TABLE `Event_Performances` (
  `event_performance_id` int(11) NOT NULL AUTO_INCREMENT,
  `performance_id` int(11) DEFAULT NULL,
  `event_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`event_performance_id`),
  UNIQUE KEY `event_performance_id` (`event_performance_id`),
  KEY `performance_id` (`performance_id`),
  KEY `Event_Performances_ibfk_4` (`event_id`),
  CONSTRAINT `Event_Performances_ibfk_3` FOREIGN KEY (`performance_id`) REFERENCES `Performances` (`performance_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Event_Performances_ibfk_4` FOREIGN KEY (`event_id`) REFERENCES `Events` (`event_id`) ON DELETE CASCADE ON UPDATE CASCADE
